                    ...
                    switch (opcao) {
                        ...
                        case 3:
                            ...
                            for (int i = 0; i < vetorDeProjetos.length; i++) {
                                if (vetorDeProjetos[i] != null && vetorDeProjetos[i].getCodProj() == cod) {
                            ...
                            break;
                        case 4:
                            System.out.print("Qual o titulo do projeto: ");
                            String titulo = teclado.nextLine();
                            for (int i = 0; i < vetorDeProjetos.length; i++) {
                                if (vetorDeProjetos[i] != null && vetorDeProjetos[i].getTitulo().equals(titulo)) {
                                    System.out.println(vetorDeProjetos[i]);
                                    i = vetorDeProjetos.length;
                                } else if (i == vetorDeProjetos.length - 1) {
                                    System.out.println("Não há projeto com esse titulo.");
                                }
                            }
                            break;
                    }
